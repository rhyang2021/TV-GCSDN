...
% % % --------------------------------------------------------------- % % %
%% gender age SES
[num,~] = xlsread('../phenotypeData/phenotypeNew.xlsx');
...
load('../resultData/myResult_wid4_RegressHeadMotion_3HRF_noctrlSuddenMove_PatternSearch_initial.mat')
nWin = 59;
...
save('../resultData/finalData_windowLevel','FinalDataAll','names');
% clear name names
disp('The end ... ...')